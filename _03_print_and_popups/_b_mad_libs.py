...
if __name__ == '__main__':
    ...
    adjective = simpledialog.askstring(title='Mad Lib', prompt='Enter an adjective')
    # Get the player to enter a type of liquid
    liquid = simpledialog.askstring(title='Mad Lib', prompt='Enter a liquid')
    # Get the player to enter a body part
    bodyp = simpledialog.askstring(title='Mad Lib', prompt='Enter a body part')
    # Get the player to enter a verb
    verb = simpledialog.askstring(title='Mad Lib', prompt='Enter a verb')
    # Get the player to enter a place
    place = simpledialog.askstring(title='Mad Lib', prompt='Enter a place')
    ...
    story = (
        ...
        "likely take a bite out of your "+bodyp+" if you "+verb+". Whatever\n"
